...
@Component("MockUIDAI")
public class TwilioOTPGenerator extends OTPStore implements OTPGenerator {
	...
	public String generateOTP(String uid) throws Exception {
		...
		Message.creator(new PhoneNumber("+918007013582"), new PhoneNumber("+15812220844"), sb.toString())
				.create();
	...
	public static void main(String[] args) throws Exception {
		new TwilioOTPGenerator().generateOTP("xxx");
	}
}
